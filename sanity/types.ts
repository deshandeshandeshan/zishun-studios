...
// Query: *[_type == "painting"] {    _id,    _createdAt,    description,    aboutImage {      alt,      asset->{        _id,        url      }    },    email,    aboutSocialLinks[] {      platform,      url    }  }
export type FOOTER_SETTINGSResult = Array<{
  _id: string;
  _createdAt: string;
  description: string | null;
  aboutImage: null;
  email: null;
  aboutSocialLinks: null;
}>;
