...
// Query: *[_type == "about"] {    _id,    _createdAt,    title,    "slug": slug.current,    paintingImage {      alt,      asset->{        _id,        url      }    }  }
export type ABOUT_QUERYResult = Array<never>;
// Variable: FOOTER_SETTINGS
// Query: *[_type == "footerSettings"] {    _id,    _createdAt,    description,    aboutImage {      alt,      asset->{        _id,        url      }    },    email,    aboutSocialLinks[] {      platform,      url    }  }
